...
Method Overriding (@Override): The Car class provides its own specific implementation of the startengine() and display() methods, overriding the default behavior inherited from the Vehicle class.
